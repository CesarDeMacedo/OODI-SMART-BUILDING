...
export const zoneData: ConceptualZoneRecord[] = [
  ...
  { level: 'level-2', zoneId: 'l2-z1', zoneName: 'Reading Gallery', layer: 'occupancy', status: 'moderate', value: 'Moderate', description: 'Typical reading-area occupancy for time of day.', classification: 'conceptual', hotspot: { x: 25, y: 40 } },
  { level: 'level-2', zoneId: 'l2-z1', zoneName: 'Reading Gallery', layer: 'comfort', status: 'good', value: 'Good', description: 'Acoustic and thermal comfort levels optimal for focused work.', classification: 'conceptual', hotspot: { x: 25, y: 40 } },
  { level: 'level-2', zoneId: 'l2-z1', zoneName: 'Reading Gallery', layer: 'air-quality', status: 'good', value: 'Good', description: 'Fresh-air supply maintaining comfortable reading conditions.', classification: 'conceptual', hotspot: { x: 25, y: 40 } },
  { level: 'level-2', zoneId: 'l2-z1', zoneName: 'Reading Gallery', layer: 'hvac', status: 'good', value: 'Reduced Demand', description: 'Quiet fan-coil operation supporting low-noise environment.', classification: 'conceptual', hotspot: { x: 25, y: 40 } },
  { level: 'level-2', zoneId: 'l2-z1', zoneName: 'Reading Gallery', layer: 'asset-health', status: 'good', value: 'Good', description: 'Lighting fixtures and furniture systems nominal.', classification: 'conceptual', hotspot: { x: 25, y: 40 } },

  // ── Level 2 · Media Lab ──────────────────────────────────────────────────
  { level: 'level-2', zoneId: 'l2-z2', zoneName: 'Media Lab', layer: 'occupancy', status: 'attention', value: 'High', description: 'Workshop session in progress — near-capacity occupancy.', classification: 'conceptual', hotspot: { x: 51, y: 39 } },
  { level: 'level-2', zoneId: 'l2-z2', zoneName: 'Media Lab', layer: 'comfort', status: 'moderate', value: 'Moderate', description: 'Elevated heat load from equipment and occupancy.', classification: 'conceptual', hotspot: { x: 51, y: 39 } },
  { level: 'level-2', zoneId: 'l2-z2', zoneName: 'Media Lab', layer: 'air-quality', status: 'moderate', value: 'Moderate', description: 'Increased ventilation load from active session — monitored.', classification: 'conceptual', hotspot: { x: 51, y: 39 } },
  { level: 'level-2', zoneId: 'l2-z2', zoneName: 'Media Lab', layer: 'hvac', status: 'moderate', value: 'Balanced', description: 'Zone demand elevated to manage workshop thermal load.', classification: 'conceptual', hotspot: { x: 51, y: 39 } },
  { level: 'level-2', zoneId: 'l2-z2', zoneName: 'Media Lab', layer: 'asset-health', status: 'good', value: 'Good', description: 'AV and workspace equipment reporting nominal status.', classification: 'conceptual', hotspot: { x: 51, y: 39 } },

  // ── Level 2 · Study Zone ─────────────────────────────────────────────────
  { level: 'level-2', zoneId: 'l2-z3', zoneName: 'Study Zone', layer: 'occupancy', status: 'good', value: 'Low', description: 'Quiet study area with low occupancy.', classification: 'conceptual', hotspot: { x: 74, y: 43 } },
  { level: 'level-2', zoneId: 'l2-z3', zoneName: 'Study Zone', layer: 'comfort', status: 'good', value: 'Good', description: 'Optimal comfort conditions for individual study.', classification: 'conceptual', hotspot: { x: 74, y: 43 } },
  { level: 'level-2', zoneId: 'l2-z3', zoneName: 'Study Zone', layer: 'air-quality', status: 'good', value: 'Good', description: 'Air quality optimal with low occupancy load.', classification: 'conceptual', hotspot: { x: 74, y: 43 } },
  { level: 'level-2', zoneId: 'l2-z3', zoneName: 'Study Zone', layer: 'hvac', status: 'good', value: 'Reduced Demand', description: 'Minimal conditioning demand in quiet zone.', classification: 'conceptual', hotspot: { x: 74, y: 43 } },
  { level: 'level-2', zoneId: 'l2-z3', zoneName: 'Study Zone', layer: 'asset-health', status: 'good', value: 'Good', description: 'Study pod fixtures and outlets nominal.', classification: 'conceptual', hotspot: { x: 74, y: 43 } },
